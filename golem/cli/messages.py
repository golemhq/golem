...
Usage: golem
  ...
  golem run <project> <test|suite|directory> [-b -t -e -i -r]
            [--tags] [--report-folder] [--report-name] [--timestamp]
  golem gui [-p]
...
Usage: golem run
  ...
  Examples:
    ...
    golem run project_name folder/ --tags a_tag
  ...
  optional arguments:
    ...
    --tags               a list of tags. If used, only tests with specified tag(s) will be executed
...
Usage: golem run <project> <test|suite|directory> [-b|--browsers]
                 ...
                 [-r|--report] [--tags] [--report-folder] [--report-name]
                 [--timestamp] 
